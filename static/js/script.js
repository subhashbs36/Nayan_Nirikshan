...
(() =>{
  ...
  document.onreadystatechange = function() {
    if (document.readyState !== "complete") {
        document.querySelector(".cam-1-hero-col-2").style.display = "none";
        document.querySelector(".loader").style.display = "inline-block";
        document.querySelector(".container-load").style.display = "block";
    } else {
        document.querySelector(".cam-1-hero-col-2").style.display = "inline-block";
        document.querySelector(".loader").style.display = "none";
        document.querySelector(".container-load").style.display = "none";
        document.querySelector(".popup-link").click();
    }

    document.querySelector(".logo-new").addEventListener("click",()=>{
